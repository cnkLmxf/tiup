...
func checkConfig(ctx context.Context, e ctxt.Executor, componentName, version, nodeOS, arch, config string, paths meta.DirPaths, bindVersion BindVersion) error {
	var cmd string
